...
# Note 1: 
#   Bring in the RCurl library for 
#   more connection methods 

# Note 2: 
#   Form a valid HTTPS base URL 
#   for raw access to the GitHub repository 

# Note 3: 
#   Define a function that wraps a 
#   URL path fragment into a usable HTTPS 
#   connection 

# Note 4: 
#   Load the car data from GitHub 
#   over HTTPS 
