...
# Note 2: 
#    
#   A function to calculate the WSS for a single 
...
#   the cluster (the mean of all the points) 

# Note 4: 
#   Calculate the squared 
#   difference of every point in the cluster from the 
#   centroid, and sum all the distances 

# Note 5: 
#   Function to compute the 
#   total WSS from a set of data points and cluster 
#   labels 
