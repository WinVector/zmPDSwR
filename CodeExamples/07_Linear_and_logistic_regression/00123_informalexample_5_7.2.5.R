# informalexample:5_7.2.5 
# informalexample:5 : Linear and logistic regression : Using logistic regression : Reading the model summary and characterizing coefficients 
Coefficients:
