# informalexample:1_B.2.2 
# informalexample:1 : Some Important Statistical Concepts : Statistical theory : A/B tests 
set.seed(123515)
d <- rbind( 	# Note: 1 
...
# Note 2: 
#   Add 100000 examples from the A-group 
#   simulating a conversion rate of 5% 

# Note 3: 
#   Add 10000 examples from the B-group 
