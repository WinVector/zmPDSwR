...
# informalexample:2 : Some Important Statistical Concepts : Examples of the statistical view of data : Sampling bias 
library(ggplot2)
...
# Note 1: 
#   Plot all of the income data with linear trend 
#   line (and uncertainty band). 

# Note 2: 
#   Plot the very high income data and linear trend 
#   line (also include cut-off and portrayal of suppressed data). 
