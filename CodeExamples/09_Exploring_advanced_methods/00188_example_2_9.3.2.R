...
#   categorical variables are encoded as multiple numeric 
#   indicators 
...
#   row of the matrix and transpose results so they’re written as rows (not 
#   as a list as returned by apply()) 

# Note 6: 
#   Extend names from original matrix to names 
#   for compound variables in new matrix 
